...
extern void cf_bodyCylinderTrimmedCreate(CP_Body& b, double cx, double cy, double cz, double h, double r, double u1, double u2, double v1, double v2);
extern void cf_bodyCylinderTrimmedDrawSolid(const CP_Body& b);
extern void cf_bodyCylinderTrimmedDrawWireframe(const CP_Body& b);
extern void cf_bodyCylinderTrimmedDrawEdge(const CP_Body& b);
